...
// GAS SPECIFIC GALLERY DATA
const gasGallery = [
  { id: 1, src: "/client/one.jpeg", category: "Compliance", alt: "Landlord Gas Safety Inspection" },
  { id: 2, src: "/client/three.jpeg", category: "Installation", alt: "New Gas Pipework Infrastructure" },
  { id: 3, src: "/client/one.jpeg", category: "Safety", alt: "Emergency Gas Leak Repair" },
  { id: 4, src: "/client/three.jpeg", category: "Installation", alt: "Gas Hob & Cooker Commissioning" },
  { id: 5, src: "/client/one.jpeg", category: "Compliance", alt: "Commercial Gas Certification" },
  { id: 6, src: "/client/three.jpeg", category: "Safety", alt: "Tightness Testing Procedures" },
];
...
export default function GasServicesPage() {
  ...
  const filteredImages = filter === "All" 
    ? gasGallery 
    : gasGallery.filter(img => img.category === filter);
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] overflow-x-hidden font-sans text-[#12416B]">
      ...
      {/* --- SEO METADATA --- */}
      <head>
        <title>Gas Safe Compliance Essex | Infrastructure & Safety</title>
        <meta name="description" content="Certified Gas Safe engineers in Essex. Specialist gas compliance, landlord safety certificates, and premium installations starting from £1450." />
      </head>

      <Navbar />

      {/* Main Container with tight mobile padding (px-4) and standard desktop padding (px-20) */}
      <main className="pt-32 md:pt-48 pb-24 px-4 md:px-12 lg:px-20">
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 z-10 text-center lg:text-left">
              ...
              <h1 className="text-5xl md:text-8xl lg:text-[110px] font-black text-[#12416B] mb-8 tracking-tighter uppercase leading-[0.85] italic">
                GAS <br/>
                <span className="text-white drop-shadow-[3px_3px_0px_#12416B] md:drop-shadow-[5px_5px_0px_#12416B] [-webkit-text-stroke:1.5px_#12416B]">COMPLIANCE</span>
              </h1>
              <p className="text-lg md:text-2xl text-slate-500 max-w-xl leading-relaxed mb-10 border-l-4 border-[#F2CF51] pl-6 mx-auto lg:mx-0">
                Precision gas infrastructure and safety certification for residential assets. We provide high-capacity solutions and legal compliance.
              </p>
              <div className="flex flex-col sm:flex-row gap-6 items-center justify-center lg:justify-start">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <span className="text-[9px] font-black uppercase text-slate-400 tracking-widest leading-none text-left">Starting<br/>Investment</span>
                </div>
              </div>
            </div>
            <div className="lg:col-span-5 relative mt-12 lg:mt-0">
               <div className="relative h-[350px] md:h-[550px] w-full rounded-[2.5rem] md:rounded-[4rem] overflow-hidden border-8 md:border-[16px] border-white shadow-2xl">
                  <Image src="/client/one.jpeg" alt="Gas Infrastructure Engineer" fill className="object-cover" priority />
               </div>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto mb-32">
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { num: "01", title: "Certification", sub: "Legal Compliance", desc: "Digital CP12 Landlord Gas Safety Records and full property audits." },
              { num: "02", title: "Infrastructure", sub: "Mains & Pipes", desc: "Expert re-routing and new gas line installations for large scale projects." },
              { num: "03", title: "Emergency", sub: "Leak Detection", desc: "Precision diagnostic tracing and immediate hazardous escape repairs." }
            ].map((item, i) => (
        ...
        <section className="max-w-7xl mx-auto mb-32">
          <div className="flex flex-col lg:flex-row justify-between items-center lg:items-end gap-6 mb-12">
            <div className="text-center lg:text-left">
              <h2 className="text-4xl md:text-7xl font-black uppercase italic tracking-tighter text-[#12416B]">Work <span className="text-[#F2CF51] [-webkit-text-stroke:1px_#12416B]">Portfolio</span></h2>
            </div>
            <div className="flex flex-wrap justify-center gap-2 bg-white p-1.5 rounded-2xl shadow-sm border border-slate-100">
              {["All", "Compliance", "Installation", "Safety"].map((cat) => (
                <button
                  key={cat}
        ...
        {/* --- EXPERT SECTION: IMAGE BOTTOM ON MOBILE --- */}
        <section className="max-w-7xl mx-auto mb-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            {/* Text Box */}
            <div className="text-center lg:text-left">
              <h2 className="text-4xl md:text-7xl font-black uppercase italic text-[#12416B] mb-8 leading-none tracking-tighter">
                Security <br/><span className="text-[#F2CF51]">In Every Joint</span>
              </h2>
              <p className="text-slate-500 text-lg mb-8 leading-relaxed">
                Our Gas Safe Registered team focuses on <strong>zero-leak tolerance</strong>. We specialize in complex infrastructure and residential safety audits across Essex.
              </p>
              <div className="grid grid-cols-2 gap-4">
                 {["Pressure Testing", "CO2 Monitoring", "Flue Inspection", "Safety Purging"].map((item) => (
            ...
            {/* Image Box - code order puts this at bottom on mobile */}
            <div className="relative h-[300px] md:h-[500px] rounded-[2.5rem] md:rounded-[4rem] overflow-hidden shadow-2xl border-4 md:border-8 border-white">
              <Image src="/client/three.jpeg" alt="Gas Safety Equipment" fill className="object-cover" />
            </div>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto">
          <div className="bg-[#12416B] rounded-[2.5rem] md:rounded-[4rem] overflow-hidden flex flex-col lg:flex-row shadow-2xl border-4 md:border-[12px] border-white">
            <div className="p-8 md:p-16 lg:w-2/3 text-white">
              <h2 className="text-4xl md:text-6xl font-black uppercase italic mb-6 leading-none tracking-tighter text-center lg:text-left">Premium <br/><span className="text-[#F2CF51]">Gas Logistics</span></h2>
              <div className="grid sm:grid-cols-2 gap-4 mt-8">
                {["New Main Line Install", "Safety Audit Certs", "Emergency Trace & Fix", "Appliance Commisioning"].map((li) => (
            ...
            <div className="bg-[#F2CF51] p-10 md:p-16 lg:w-1/3 flex flex-col items-center justify-center text-[#12416B]">
               <span className="font-black uppercase text-[10px] tracking-widest mb-1 opacity-60">Packages From</span>
